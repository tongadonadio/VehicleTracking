    ...
    public class ComponentResolver
    {
            ...
            try
            {
                using (var aggregateCatalog = new AggregateCatalog())
                {
                    ...
                    using (var componsitionContainer = new CompositionContainer(aggregateCatalog))
                    {
                        ...
                        IEnumerable<Component> modules = exports.Select(export => export.Value as Component).Where(m => m != null);

                        var registerComponent = new RegisterComponentImp(container);
        ...
        private static ImportDefinition BuildImportDefinition()
        {
            return new ImportDefinition(
                def => true, typeof(Component).FullName, ImportCardinality.ZeroOrMore, false, false);
        }
    }

    internal class RegisterComponentImp : RegisterComponent
    {
        private readonly IUnityContainer _container;

        public RegisterComponentImp(IUnityContainer container)
        {
